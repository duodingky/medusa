...
export class Migration20260203190000 extends Migration {
  async up(): Promise<void> {
    this.addSql(
      'alter table if exists "public"."vendor_vendor_product_product" rename to "vendor_product";'
    );
    this.addSql(
  ...
  async down(): Promise<void> {
    this.addSql(
      'alter table if exists "public"."vendor_product" rename to "vendor_vendor_product_product";'
    );
    this.addSql(
      `update "public"."link_module_migrations"
